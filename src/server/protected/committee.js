...
export async function Assemble_Committee(contract , params, log = false){
    let t1 = Date.now()
    const args = {
    ...
    let t2 = Date.now()
    if(log){
        console.log("Assemble Committee time: " , t2-t1)
        return t2-t1
    }
    return response
}

export async function Disassemble_Committee(contract , params, log = false){
    let t1 = Date.now()
    const args = {
        Committee_Name: params["CommitteeName"]
    }
    ...
    let t2 = Date.now()
    if(log){
        console.log("Disassemble Committee time: " , t2-t1)
        return t2-t1
    }
    return response
}

export async function Vote_Protected_RTBF(contract , params, log = false){
    let t1 = Date.now()
    const args = {
        Committee_Name: params["CommitteeName"]
    }
    ...
    let t2 = Date.now()
    if(log){
        console.log("Vote Protected RTBF time: " , t2-t1)
        return t2-t1
    }
    return response
}
