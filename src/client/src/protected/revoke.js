...
const Revoke_Vote_Access = (props) => {
    ...
    // return (  
    //     <div className="Revoke Vote Access">
    //       <p>Revoke Vote Access</p>
    ...
    //         {!pending && <button>Revoke Vote Access</button>}
      ...
      <div className="row justify-content-center mt-5">
        <div className="col-md-6">
          <div className="bg-secondary p-3 text-center">
            <p className="m-0 text-white">Revoke Vote Access</p>
          </div>
          <br />
          <form onSubmit={handleSubmit}>
            ...
            {!pending && <button type="submit" className="btn btn-primary d-block mx-auto">Revoke Vote Access</button>}
...
export default Revoke_Vote_Access;
