...
const Revoke_Access_Control = (props) => {
    ...
    // return (  
    //     <div className="Revoke_Access_Control">
        ...
        <div className="row justify-content-center mt-5">
          <div className="col-md-6">
            <div className="bg-secondary p-3 text-center">
              <p className="m-0 text-white">Revoke Access Control</p>
            </div>
            <br />
            <form onSubmit={handleSubmit}>
              ...
              {!pending && <button type="submit" className="btn btn-primary d-block mx-auto">Revoke Access Control</button>}
...
export default Revoke_Access_Control;
