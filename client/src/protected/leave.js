...
const Leave_Committee = (props) => {
  ...
  //         {!pending && <button>Leave Committe</button>}
      ...
      <div className="row justify-content-center mt-5">
        <div className="col-md-6">
          <div className="bg-secondary p-3 text-center">
            <p className="m-0 text-white">Leave Committee</p>
          </div>
          <br />
          <form onSubmit={handleSubmit}>
            ...
            {!pending && <button type="submit" className="btn btn-primary d-block mx-auto">Leave Committee</button>}
...
export default Leave_Committee;
