...
const Destruct_Access_Control_List = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        setPending(true)
        const request = {
            method: "Destruct_Access_Control_List",
        ...
        <div className="container">
          <div className="row justify-content-center mt-5">
            ...
            <div className="bg-secondary p-3 text-center">
                <p className="m-0 text-white">Destruct Access Control List</p>
            </div>
            <br/>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {!pending && <button type="submit" className="btn btn-primary d-block mx-auto">Destruct Access Control List</button>}
...
export default Destruct_Access_Control_List;
